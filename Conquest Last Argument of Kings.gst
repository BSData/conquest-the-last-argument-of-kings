...
<gameSystem id="dd30-0080-e51a-c53f" name="Conquest: Last Argument of Kings" revision="5" battleScribeVersion="2.03" authorName="Ragnarok494" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <categoryEntries>
    ...
    <categoryEntry id="d97f-110c-2396-892f" name="Restricted (Eccentric)" hidden="false"/>
  </categoryEntries>
  <forceEntries>
    <forceEntry id="5953-df28-3b4e-ae06" name="Warband" hidden="false">
      ...
      <categoryLinks>
        ...
        <categoryLink id="816b-e7ca-8193-ca81" name="Restricted (Eccentric)" hidden="true" targetId="d97f-110c-2396-892f" primary="false">
          <modifiers>
            <modifier type="set" field="d615-9096-731f-ebe7" value="1.0">
              <conditions>
                <condition field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="42e7-8903-a155-1cb6" type="equalTo"/>
              </conditions>
            </modifier>
            ...
            <modifier type="set" field="a0d0-0804-0cdd-bd3b" value="1.0">
              <conditions>
                <condition field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="42e7-8903-a155-1cb6" type="equalTo"/>
              </conditions>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="d615-9096-731f-ebe7" type="max"/>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="a0d0-0804-0cdd-bd3b" type="min"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
